...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'about.work.point1': 'I keep code readable, stable, and easy to hand over.',
    'about.work.point2': 'I prefer clear scope and short feedback loops.',
    'about.work.point3': 'I care about the handoff as much as the implementation.',
    'about.work.cta': "Let's talk",
  ...
  pt: {
    ...
    'about.snapshot': 'Resumo',
    'about.work.title': 'Como trabalho',
    'about.work.point1': 'Mantenho o código legível, estável e fácil de passar adiante.',
    'about.work.point2': 'Prefiro escopo claro e ciclos curtos de feedback.',
    'about.work.point3': 'Dou atenção ao handoff tanto quanto à implementação.',
    'about.work.cta': 'Vamos conversar',
  ...
  es: {
    ...
    'about.snapshot': 'Resumen',
    'about.work.title': 'Cómo trabajo',
    'about.work.point1': 'Mantengo el código legible, estable y fácil de entregar.',
    'about.work.point2': 'Prefiero un alcance claro y ciclos cortos de feedback.',
    'about.work.point3': 'Me importa tanto el traspaso como la implementación.',
    'about.work.cta': 'Hablemos',
  ...
  fr: {
    ...
    'about.snapshot': 'Aperçu',
    'about.work.title': 'Ma façon de travailler',
    'about.work.point1': 'Je garde un code lisible, stable et facile à transmettre.',
    'about.work.point2': 'Je préfère un périmètre clair et des cycles de retour courts.',
    'about.work.point3': 'Je soigne autant la transmission que l’implémentation.',
    'about.work.cta': 'Parlons-en',
